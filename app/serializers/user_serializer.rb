...
class UserSerializer < ActiveModel::Serializer
  ...
  attributes :id, :first_name, :last_name, :birthdate, :profession, :email, :mentorships, :avatar_source_url, :avatar_cropped_url, :company, :type, :menteeships, :preapproval_token, :roles, :converted_at, :linkedin_url, :visibility
