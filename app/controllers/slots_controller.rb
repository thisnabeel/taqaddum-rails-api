class SlotsController < ApplicationController
  ...
  def create
    ...
    if @slot.save
      render json: @slot, status: :created, location: @slot, serializer: SlotSerializer, include_user: true
    else
  ...
  private
    ...
    def slot_params
      params.require(:slot).permit(:user_id, :meeting_offering_id, :start_time, :end_time, :status, :description, :title, :timezone, :mentorship_id)
    end
end
